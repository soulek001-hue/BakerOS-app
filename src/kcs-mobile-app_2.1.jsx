              ...
              <div style={{padding:"14px",display:"flex",flexDirection:"column",gap:10}}>
                ...
                <div style={{borderRadius:14,overflow:"hidden",border:"1px solid var(--bd)"}}>
                  ...
                  <div style={{background:adTheme.bg,padding:"24px 18px 18px",textAlign:"center",position:"relative"}}>
                    ...
                    <div style={{fontSize:10,color:adTheme.text,opacity:.65,letterSpacing:"2px",textTransform:"uppercase"}}>{BAKER_CTX.location || "Your City"}</div>
...
function CalendarPage() {
  ...
  const HOLIDAYS = useMemo(() => [
    // ── 2025 ──
    { date:"2025-05-26", name:"Memorial Day",              emoji:"🇺🇸", color:"#DC2626", idea:`Patriotic red, white & blue treats! Offer a BBQ party cake bundle perfect for ${cityName} backyard celebrations. Star-shaped cookies and flag cake rolls are crowd favorites.` },
    { date:"2025-06-15", name:"Father's Day",              emoji:"👔", color:"#3D5A99", idea:`Dads in ${cityName} love treats too! Offer a 'Dad Box' — cookies, brownies, and a custom cake. Try sports-themed or 'World's Best Dad' cookie sets for a personal touch.` },
    { date:"2025-06-19", name:"Juneteenth",                emoji:"✊", color:"#DC2626", idea:`Celebrate freedom with a community special in ${cityName}. Red velvet is a traditional Juneteenth dessert — perfect for your menu! Consider donating a portion of sales to a local cause.` },
    { date:"2025-07-04", name:"Independence Day",          emoji:"🎆", color:"#DC2626", idea:`Patriotic cakes and cookie boxes for the 4th! ${cityName} loves to celebrate — star-shaped cookies and flag cakes always sell fast. Book orders 2 weeks in advance!` },
    { date:"2025-08-01", name:"National Friendship Day",   emoji:"👭", color:"#DB2777", idea:`Perfect excuse for a 'treat yourself' campaign in ${cityName}! Promote a friends & family cookie box or mini celebration cake. Pair with a 'buy one give one' deal.` },
    { date:"2025-09-01", name:"Labor Day",                 emoji:"🛠️", color:"#3D5A99", idea:`End-of-summer cookout treats for ${cityName} families! Offer a party cake bundle for Labor Day weekend. Great time to run a summer closeout sale on cookie boxes.` },
    { date:"2025-09-15", name:"Hispanic Heritage Month",   emoji:"🌮", color:"#C47B00", idea:`Celebrate Hispanic Heritage Month with your ${cityName} community! Feature pan dulce, tres leches, and Latin-inspired flavors all month long through October 15.` },
    { date:"2025-10-13", name:"Columbus Day",              emoji:"⚓", color:"#3D5A99", idea:`Long weekend in ${cityName} = more celebrations! Promote custom cakes for fall gatherings and weekend parties. Great time to push Halloween pre-orders too.` },
    { date:"2025-10-31", name:"Halloween",                 emoji:"🎃", color:"#C47B00", idea:`Spooky decorated cookies, ghost cupcakes, and Halloween cakes for ${cityName}! Start promoting mid-October with a 'Countdown to Halloween' cookie drop series on social.` },
    { date:"2025-11-01", name:"Día de los Muertos",        emoji:"💀", color:"#7C5CBF", idea:`Día de los Muertos is a beautiful celebration in ${cityName}! Offer sugar skull cookies and marigold-decorated cakes. Share the cultural meaning in your posts — customers love the story.` },
    { date:"2025-11-11", name:"Veterans Day",              emoji:"🎖️", color:"#3D5A99", idea:`Honor ${cityName}'s veterans with a heartfelt discount or a 'red, white & blue' cookie box. Tag a veteran in your post and thank them — great community engagement.` },
    { date:"2025-11-27", name:"Thanksgiving",              emoji:"🦃", color:"#C47B00", idea:`Pumpkin, pecan, and apple-flavored cakes are huge in ${cityName}. Offer a Thanksgiving dessert bundle starting 2 weeks out. Families plan holiday orders early — don't wait!` },
    { date:"2025-11-28", name:"Black Friday",              emoji:"🛍️", color:"#DC2626", idea:`Launch a Black Friday flash sale on gift boxes and cookie sets! Limited-time deals create urgency in ${cityName}. Bundle cookies + a holiday card for a giftable set.` },
    { date:"2025-12-12", name:"Día de Nuestra Señora",     emoji:"🌹", color:"#DC2626", idea:`A beloved feast day in many ${cityName} communities. Traditional pan dulce and celebration cakes for the occasion. A beautiful opportunity to connect with your local community.` },
    ...
    { date:"2026-02-02", name:"Groundhog Day",             emoji:"🦔", color:"#C47B00", idea:`Fun, lighthearted holiday! 'Shadow or no shadow — there's always cake!' Offer a punxsutawney-themed cookie or a spring preview treat. A great talking point on social.` },
    ...
    { date:"2026-04-05", name:"Easter",                    emoji:"🐣", color:"#059669", idea:`Easter basket cakes, egg-shaped cookies, and spring cupcakes for ${cityName} families. One of the biggest bakery holidays of the year! Offer a 'Spring Cookie Decorating Kit' for kids.` },
    { date:"2026-04-22", name:"Earth Day",                 emoji:"🌍", color:"#16A34A", idea:`Go green for Earth Day in ${cityName}! Promote eco-friendly packaging, plant-based treats, or a 'give back to nature' campaign. Great for authentic brand storytelling on social.` },
    ...
    { date:"2027-04-25", name:"Easter",                    emoji:"🐣", color:"#059669", idea:`Easter basket cakes, egg-shaped cookies, and spring cupcakes for ${cityName} families. One of the biggest bakery holidays of the year! A 'Spring Cookie Decorating Kit' is perfect for kids.` },
