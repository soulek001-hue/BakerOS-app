...
export default function App() {
  ...
  async function handleOAuth(provider) {
    ...
    const { error } = await supabase.auth.signInWithOAuth({
      provider,
      options: { redirectTo: 'https://app.bakeros.app' }
    });
  ...
  if (!session) return (
    <div style={{display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center',height:'100vh',background:'#FDF6EC',padding:24,fontFamily:'sans-serif'}}>
      ...
      <button onClick={()=>handleOAuth('apple')} disabled={authWorking}
        style={{width:'100%',maxWidth:320,padding:'12px 14px',borderRadius:10,border:'1.5px solid #ddd',marginBottom:10,fontSize:14,background:'#000',color:'#fff',cursor:'pointer',display:'flex',alignItems:'center',justifyContent:'center',gap:10,fontWeight:600,boxSizing:'border-box'}}>
        <svg width="18" height="18" viewBox="0 0 814 1000" fill="white"><path d="M788.1 340.9c-5.8 4.5-108.2 62.2-108.2 190.5 0 148.4 130.3 200.9 134.2 202.2-.6 3.2-20.7 71.9-68.7 141.9-42.8 61.6-87.5 123.1-155.5 123.1s-85.5-39.5-164-39.5c-76 0-103.7 40.8-165.9 40.8s-105-37.6-159.2-93.3C27.8 749.8 1 636.3 1 522.6c0-261.3 166.9-400.1 328.2-400.1 87.2 0 159.9 57.3 215 57.3 52.9 0 135.9-60.6 236.3-60.6zm-189.3-65.7c-34.5 40.8-90.7 72.5-140.9 72.5-2 0-4 0-5.9-.3-.6-50.6 19.7-103.7 54.7-139.7 39.5-40.9 104.5-75.3 155.5-77.5 1.5 52.5-13.4 106.6-63.4 145z"/></svg>
        Continue with Apple
      </button>
