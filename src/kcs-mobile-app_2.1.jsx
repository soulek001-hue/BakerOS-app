...
function CalendarPage() {
  ...
  // Holidays in the NEXT month (for advance planning)
      ...
      {nextMonthHolidays.length > 0 && (
        <div style={{padding:"0 12px 12px"}}>
          <div style={{display:"flex",alignItems:"center",gap:8,marginBottom:9}}>
            ...
            <div style={{fontSize:10,fontWeight:700,background:"color-mix(in srgb,#C47B00 14%,var(--sf))",color:"#C47B00",borderRadius:20,padding:"2px 8px"}}>Plan ahead</div>
          </div>
          <div style={{display:"flex",flexDirection:"column",gap:8}}>
