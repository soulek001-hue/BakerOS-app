...
export default function App() {
  ...
  const [publicLoading, setPublicLoading] = React.useState(!!urlSlug);
  const [publicError,  setPublicError]  = React.useState(null);
