  ...
  return (
    <style>{`
      ...
      *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
      html,body{height:100%;margin:0;overflow:hidden;font-family:var(--fb);background:var(--bg);color:var(--tx);-webkit-font-smoothing:antialiased;} #root{height:100%;overflow:hidden;}
...
function WalkthroughOverlay({ pageKey, onClose }) {
  ...
  return (
    <div style={{position:"fixed",inset:0,background:"rgba(0,0,0,.55)",backdropFilter:"blur(3px)",zIndex:500,display:"flex",alignItems:"flex-end"}}>
      <div style={{width:"100%",maxWidth:430,margin:"0 auto",background:"var(--sf)",borderRadius:"20px 20px 0 0",padding:"20px 20px calc(32px + env(safe-area-inset-bottom,0px))",animation:"slideUp .3s cubic-bezier(.22,.68,0,1.1) both"}}>
...
export default function App() {
  ...
  return (
    <TierCtx.Provider value={tierCtxValue}>
      <Ctx.Provider value={brand}>
        <GlobalCSS brand={brand}/>
        <div style={{maxWidth:430,margin:"0 auto",height:"100dvh",position:"relative",background:"var(--bg)",overflow:"hidden",display:"flex",flexDirection:"column",boxShadow:"0 0 60px rgba(0,0,0,.15)"}}>
          ...
          <div className="page-scroll" style={{flex:1,paddingTop:44,paddingBottom:inBottom?"calc(96px + env(safe-area-inset-bottom, 0px))":"96px",overflowY:"auto",WebkitOverflowScrolling:"touch",overscrollBehavior:"contain",minHeight:0}}>
            {renderPage()}
