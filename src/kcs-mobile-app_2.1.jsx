  ...
  const send = () => {
    ...
    const sends = targets.map(c =>
      fetch("/api/notify",{
        ...
        body:JSON.stringify({customerName:c.name, item:"Marketing Campaign", amount:0, phone:c.phone, customMessage:msg})
      }).catch(()=>{})
    );
...
function StorefrontMessageForm({ onSent }) {
  ...
  const submit = () => {
    ...
    fetch("/api/notify",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({customerName:form.name,item:`Message: ${form.subject||"Storefront inquiry"}`,amount:0,phone:form.phone})}).catch(()=>{});
  };
  ...
  const renderPage = () => {
    switch(page) {
      ...
      case "orderform":   return <OrderFormPage products={products} photos={photos} addOrder={(o)=>{
        ...
        fetch("/api/notify",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({customerName:o.customer,item:o.item,amount:o.amount,phone:o.phone})}).catch(()=>{});
      }}/>;
