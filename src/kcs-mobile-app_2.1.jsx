...
function CustomerStorefrontPage({ products, categories, photos, brand, socialLinks, bakerInfo, setPage, isOwnerPreview = false }) {
  ...
  return (
    <div style={{paddingBottom:96,background:"#FDF6EC",minHeight:"100dvh"}}>
      ...
      <div style={{background:`linear-gradient(170deg,${brand.theme.text||"#3D1C00"} 0%,color-mix(in srgb,${primary} 60%,#000) 60%,${primary} 100%)`,padding:"36px 24px 28px",textAlign:"center",position:"relative",overflow:"hidden"}}>
        ...
        <button
          onClick={()=>{ if(isOwnerPreview){ setPage("orderform"); } else { const el=document.getElementById("public-order-form"); if(el) el.scrollIntoView({behavior:"smooth"}); } }}
        ...
        <div style={{display:"flex",alignItems:"center",justifyContent:"center",gap:12,marginTop:16}}>
          <button onClick={()=>{const url=isOwnerPreview?`https://app.bakeros.app/store/${bakerInfo?.username||brand?.bakeryUsername||"bakeros"}`:window.location.href;if(navigator.clipboard)navigator.clipboard.writeText(url);show("Link copied ✓");}} style={{background:"rgba(255,255,255,.12)",color:"rgba(255,255,255,.8)",border:"1px solid rgba(255,255,255,.2)",borderRadius:30,padding:"7px 16px",fontSize:11,fontFamily:"var(--fb)",fontWeight:700,cursor:"pointer",letterSpacing:".5px"}}>Copy Link</button>
          <button onClick={()=>{
  const url = isOwnerPreview ? `https://app.bakeros.app/store/${bakerInfo?.username||brand?.bakeryUsername||"bakeros"}` : window.location.href;
  if(navigator.share){navigator.share({title:brand?.storeName||bakerInfo?.name||"My Bakery",text:"Check out my bakery!",url}).catch(()=>{});}
      ...
      {/* Message form — hidden on baker's own storefront preview */}
...
function StorefrontPage({ products, categories, photos, bakerInfo, setBakerInfo, setPage }) {
      ...
      <div style={{padding:"0 12px",display:"flex",flexDirection:"column",gap:11}}>
        ...
        <div className="card" style={{padding:"13px 14px"}}>
          ...
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:8}}>
            ...
            <button className="gbtn" onClick={()=>{
  const url = `https://app.bakeros.app/store/${bakerInfo?.username||brand?.bakeryUsername||"bakeros"}`;
  if(navigator.share){navigator.share({title:bakerInfo?.name||"My Bakery",text:"Check out my bakery page!",url}).catch(()=>{});}
        ...
        <div className="card" style={{padding:"14px",textAlign:"center"}}>
          <div className="qr-storefront-wrap" style={{border:"2px solid var(--bd)",borderRadius:11,padding:3,display:"inline-block",margin:"0 auto 10px",background:"#fff"}}><QRCodeDisplay url={`https://app.bakeros.app/store/${bakerInfo?.username||brand?.bakeryUsername||"bakeros"}`} size={94} primaryColor={b.theme.primary}/></div>
          <button className="gbtn" onClick={()=>{
  ...
  if(canvas){const a=document.createElement("a");a.download="bakeros-qr.png";a.href=canvas.toDataURL("image/png");a.click();show("QR downloaded ✓");}
        ...
        {/* ── Message the baker ── */}
        <div id="public-order-form" className="card" style={{padding:"16px"}}>
  ...
  return (
    <div style={{paddingBottom:96}}>
      ...
      <div style={{padding:"0 12px", display:"flex", flexDirection:"column", gap:12}}>
        ...
        {/* ── STEP 2: Select items + attach images ── */}
        {step===2 && (
          <>
        ...
        {/* ── STEP 1: Contact details + Inspiration ── */}
        {step===1 && (
          <>
            ...
            {showFirstBanner && page==="home" && (
              <div style={{margin:"0 12px 12px",background:`color-mix(in srgb,${brand.theme.primary} 10%,var(--sf))`,border:`1.5px solid ${brand.theme.primary}40`,borderRadius:14,padding:"13px 15px",display:"flex",gap:11,alignItems:"center"}}>
                ...
                <div style={{display:"flex",flexDirection:"column",gap:6,flexShrink:0}}>
                  <button onClick={()=>{if(navigator.clipboard)navigator.clipboard.writeText(`https://app.bakeros.app/store/${brand.bakeryUsername||bakerInfo?.username||"bakeros"}`);track("linkCopied");setShowFirstBanner(false);}} style={{background:brand.theme.primary,color:"#fff",border:"none",borderRadius:9,padding:"7px 12px",fontSize:11,fontWeight:800,cursor:"pointer",fontFamily:"var(--fb)"}}>Copy Link</button>
