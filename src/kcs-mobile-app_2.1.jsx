...
export default class ErrorBoundary extends React.Component {
  ...
  componentDidCatch(error, info) { console.error("BakerOS crash:", error, info); }
  render() {
    if (this.state.error) {
      return (
        <div style={{padding:24,fontFamily:"sans-serif",background:"#fff",minHeight:"100vh"}}>
          <div style={{fontSize:20,fontWeight:700,color:"#DC2626",marginBottom:12}}>⚠ App Error</div>
          <div style={{fontSize:13,color:"#333",background:"#FEF2F2",padding:12,borderRadius:8,marginBottom:12,wordBreak:"break-all"}}>
            {this.state.error.message}
          </div>
          <div style={{fontSize:11,color:"#888",whiteSpace:"pre-wrap",wordBreak:"break-all"}}>
            {this.state.error.stack?.slice(0,500)}
          </div>
          <button onClick={()=>this.setState({error:null})} style={{marginTop:16,padding:"10px 20px",background:"#C47B00",color:"#fff",border:"none",borderRadius:8,fontSize:14,cursor:"pointer"}}>
            Try Again
          </button>
        </div>
      );
