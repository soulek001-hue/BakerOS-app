              ...
              <div style={{display:"flex",flexDirection:"column",gap:8}}>
                ...
                {products.map(p => (
                  <div key={p.id} style={{display:"flex",alignItems:"center",gap:10,padding:"10px 12px",background:"var(--sf)",borderRadius:11,border:`1px solid ${primary}30`}}>
                    ...
                    <button onClick={()=>{ if(!window.confirm(`Remove "${p.name}" from your menu? This cannot be undone.`)) return; removeProduct(p.id); }} style={{background:"none",border:"none",color:"var(--mu)",fontSize:15,cursor:"pointer",fontWeight:700}}>✕</button>
                  </div>
                ))}
              </div>
            )}
