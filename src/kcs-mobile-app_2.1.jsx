    ...
    <div style={{paddingBottom:96}}>
      ...
      <div style={{padding:"0 12px",display:"flex",flexDirection:"column",gap:11}}>
        ...
        <div className="card" style={{padding:"13px 14px"}}>
          ...
          <div style={{fontSize:13,fontWeight:600,color:"var(--tx)",marginBottom:9}}>{getStorefrontURL(brand, bakerInfo)}</div>
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:8}}>
            <button className="pbtn" onClick={()=>{if(navigator.clipboard)navigator.clipboard.writeText(getStorefrontURL(brand,bakerInfo));show("Link copied ✓");}} style={{fontSize:12}}>Copy Link</button>
            <button className="gbtn" onClick={()=>{
