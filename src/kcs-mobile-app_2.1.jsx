          ...
          <div style={{padding:"20px 20px 0"}}>
            ...
            <div style={{display:"flex",flexDirection:"column",gap:13}}>
              ...
              <Fld label="Instagram (optional)" hint="Your bakery's Instagram handle — shows on your storefront">
                <div style={{position:"relative"}}>
                  <input className="field" placeholder="@yourbakery" value={bakery.instagram||""} onChange={e=>setBakery(p=>({...p,instagram:e.target.value}))} style={{paddingLeft:28}}/>
...
export default function App() {
  ...
  const completeOnboarding = useCallback(() => {
    ...
    if (obBakery.instagram) setSocialLinks(p => ({...p, instagram: obBakery.instagram}));
