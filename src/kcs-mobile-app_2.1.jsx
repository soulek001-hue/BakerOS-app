...
function CustomerStorefrontPage({ products, categories, photos, brand, socialLinks, bakerInfo, setPage, isOwnerPreview }) {
  const [filterCat,  setFilterCat]  = useState("all");
  ...
  if(navigator.share){navigator.share({title:bakerInfo?.name||"My Bakery",text:"Check out my bakery!",url}).catch(()=>{});}
      ...
      {/* Message form */}
      {!isOwnerPreview && false && <div style={{padding:"24px 12px 0"}}>
...
function StorefrontPage({ products, categories, photos, bakerInfo, setBakerInfo, setPage }) {
  ...
  if(canvas){const a=document.createElement("a");a.download="bakeros-qr.png";a.href=canvas.toDataURL("image/png");a.click();show("QR downloaded ✓");}
        ...
        {/* ── Message the baker ── */}
        {!isOwnerPreview && false && <div className="card" style={{padding:"16px"}}>
