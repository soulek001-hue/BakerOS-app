...
function CalendarPage() {
  ...
  const HOLIDAYS = useMemo(() => [
    ...
    { date:"2026-05-05", name:"Cinco de Mayo",         emoji:"🌮", color:"#C47B00", idea:"Celebrate ${cityName}'s culture! Mexican-inspired flavors like horchata cake or tres leches are perfect." },
    ...
    { date:"2026-09-15", name:"Hispanic Heritage Month",emoji:"🇲🇽",color:"#C47B00",idea:"Celebrate with your ${cityName} community! Feature pan dulce, tres leches, and Mexican-inspired flavors all month." },
    ...
    { date:"2026-11-01", name:"Dia de los Muertos",    emoji:"💀", color:"#7C5CBF", idea:"A beautiful celebration in ${cityName}! Offer sugar skull cookies and marigold-decorated cakes. A beautiful cultural celebration." },
    ...
    { date:"2026-12-12", name:"Día de Nuestra Señora", emoji:"🌹", color:"#DC2626", idea:"Deeply celebrated in many ${cityName} communities. Traditional pan dulce and celebration cakes for the feast day." },
