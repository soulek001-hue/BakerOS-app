    ...
    <div style={{paddingBottom:96}}>
      ...
      {showSMSPicker && sel && (
        <div className="sheet">
          ...
          <div className="sheet-panel" style={{paddingBottom:0,display:"flex",flexDirection:"column",maxHeight:"88vh"}}>
            <div style={{width:36,height:4,background:"var(--bd)",borderRadius:2,margin:"12px auto 6px",flexShrink:0}}/>
            <div style={{overflowY:"auto",WebkitOverflowScrolling:"touch",flex:1,minHeight:0,padding:"4px 16px 24px"}}>
      ...
      {showManageSMS && (
        <div className="sheet">
          ...
          <div className="sheet-panel" style={{paddingBottom:0,display:"flex",flexDirection:"column",maxHeight:"92vh"}}>
            <div style={{width:36,height:4,background:"var(--bd)",borderRadius:2,margin:"12px auto 6px",flexShrink:0}}/>
            <div style={{overflowY:"auto",WebkitOverflowScrolling:"touch",flex:1,minHeight:0,padding:"4px 16px 24px"}}>
