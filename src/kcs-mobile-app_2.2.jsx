    ...
    <div style={{paddingBottom:96}}>
      ...
      {showSMSPicker && sel && (
        <div className="sheet">
          ...
          <div id="sms-picker-sheet" key={`sms-${showSMSPicker}`} className="sheet-panel" style={{maxHeight:"88vh",overflowY:"auto",WebkitOverflowScrolling:"touch",scrollBehavior:"auto",paddingBottom:"24px"}}>
      ...
      {showManageSMS && (
        <div className="sheet">
          ...
          <div id="manage-sms-sheet" key={`manage-${showManageSMS}`} className="sheet-panel" style={{maxHeight:"92vh",overflowY:"auto",WebkitOverflowScrolling:"touch",scrollBehavior:"auto",paddingBottom:"24px"}}>
            <div style={{width:36,height:4,background:"var(--bd)",borderRadius:2,margin:"12px auto 6px"}}/>
