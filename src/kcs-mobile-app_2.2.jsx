...
function OrdersPage({ extraOrders=[], setAppOrders=()=>{}, customers=[], setCustomers=()=>{}, invoices=[], setInvoices=()=>{}, reminders=[], setReminders=()=>{}, tier="" }){
  ...
  const smsSheetRef = React.useRef(null);
  const openSMS = () => {
    ...
    setTimeout(() => { if (smsSheetRef.current) smsSheetRef.current.scrollTop = 0; }, 50);
  };
    ...
    <div style={{paddingBottom:96}}>
      ...
      {showSMSPicker && sel && (
        <div className="sheet">
          ...
          <div ref={smsSheetRef} className="sheet-panel" style={{maxHeight:"88vh",overflowY:"auto",WebkitOverflowScrolling:"touch"}}>
