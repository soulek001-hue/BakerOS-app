            ...
            <div style="font-family:'Helvetica Neue',sans-serif;max-width:520px;margin:0 auto;background:#FFFBF5;border-radius:16px;overflow:hidden;border:1px solid #E8D5C0;">
              ...
              <div style="padding:28px 32px;">
                ...
                <div style="text-align:center;margin-bottom:20px;">
                  <a href="mailto:${bakerInfo?.email || 'hello@bakeros.app'}" style="background:#C47B00;color:#fff;padding:14px 36px;border-radius:12px;text-decoration:none;font-weight:800;font-size:15px;display:inline-block;">💬 Message Bakery →</a>
                </div>
                <p style="font-size:13px;color:#9C7B5C;text-align:center;margin:0;">Questions? Just reply to this email and we'll get back to you.</p>
              </div>
              <div style="background:#F0E4D4;padding:14px 24px;text-align:center;">
