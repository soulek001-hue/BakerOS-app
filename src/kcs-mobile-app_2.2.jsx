...
/* ── OTHER PAGES ───────────────────────────── */
function CRMPage({ customers=[], setCustomers=()=>{}, orders=[] }){
  const b = useBrand();
...
export default function App() {
  ...
  const renderPageInner = () => {
    switch(page) {
      ...
      case "crm":         return tier==="starter" ? <GateWall feature="crm"><CRMPage customers={customers} setCustomers={setCustomers} orders={appOrders}/></GateWall> : <CRMPage customers={customers} setCustomers={setCustomers} orders={appOrders}/>;
