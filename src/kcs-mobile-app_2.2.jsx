    ...
    switch(page) {
      ...
      case "orderform":   return <OrderFormPage products={products} photos={photos} bakerInfo={bakerInfo} addOrder={async(o)=>{
        ...
        if (o.email) {
          ...
          const storefrontURL = `https://app.bakeros.app/store/${brand?.bakeryUsername||(brand?.storeName||"bakery").toLowerCase().replace(/\s+/g,"-").replace(/[^a-z0-9-]/g,"")}`;
          const confirmHTML = `
            <div style="font-family:'Helvetica Neue',sans-serif;max-width:520px;margin:0 auto;background:#FFFBF5;border-radius:16px;overflow:hidden;border:1px solid #E8D5C0;">
              <div style="background:#C47B00;padding:28px 32px;text-align:center;">
              ...
              <div style="padding:28px 32px;">
                ...
                <div style="text-align:center;margin-bottom:20px;">
                  <a href="${storefrontURL}" style="background:#C47B00;color:#fff;padding:14px 36px;border-radius:12px;text-decoration:none;font-weight:800;font-size:15px;display:inline-block;">Visit Our Storefront →</a>
                </div>
